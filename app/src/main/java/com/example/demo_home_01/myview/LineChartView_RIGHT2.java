package com.example.demo_home_01.myview;
...
public class LineChartView_RIGHT2 extends View {

    private int lineColor =Color.parseColor("#B0E0E6");//曲线颜色
    private int pointColor = Color.parseColor("#AFEEEE");//锚点颜色
    ...
    private int stepSpaceDefault = 20;
    ...
    private int rulerValueDefault = 1;
    ...
    private int tableColor = Color.parseColor("#000000");//表格线颜色
    ...
    public LineChartView_RIGHT2(Context context) {
        this(context, null);
    }

    public LineChartView_RIGHT2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LineChartView_RIGHT2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        stepSpace = stepSpaceDP;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //  ****修改标记
        setMeasuredDimension(widthMeasureSpec, height);//设置自己的宽度和高度
    }
     ...
     * @param textMaxWidtth
     */
    private void drawRulerYText(Canvas canvas, String text, float x, float y, int width, float textMaxWidtth) {
        textRulerPaint.setTextAlign(Paint.Align.LEFT);
...
//        drawText(canvas, textRulerPaint, text, newX, newY);
        ...
        //这里重新设置绘画的x  让他在右边画
//        Point linePoint = linePoints[linePoints.length - 1];
//        drawText(canvas, textRulerPaint, text, linePoint.x+stepSpace+rulerValuePadding, newY);

        //这里减去边距 再减去文字的宽度
        drawText(canvas, textRulerPaint, text, width-rulerValuePadding-textMaxWidtth, newY);
    ...
    private void drawTable(Canvas canvas) {
        ...
        float textMaxWidtth = textRulerPaint.measureText("100000");
        //标尺y轴连接线
        do {
            ...
            //绘制y轴刻度单位
            drawRulerYText(canvas, String.valueOf(startValue), stepStart, startHeight,getWidth(),textMaxWidtth);
...
//        drawRulerXValue(canvas);
    ...
    private void drawRulerXValue(Canvas canvas) {
        ...
        for (int i = 0; i < linePoints.length; i++) {
            ...
            //   ****修改标记
//            drawRulerXText(canvas, Xlist.get(i), linePoints[i].x, 0);
...
//        }).getValue();
        ...
        stepSpace= (screenWidth -rulerValuePadding*2-tablePadding*2-200)/ dataList.size();
