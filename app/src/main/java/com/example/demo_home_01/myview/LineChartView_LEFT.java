...
public class LineChartView_LEFT extends View {

    private int lineColor =Color.parseColor("#A52A2A");//曲线颜色
    private int pointColor = Color.parseColor("#DC143C");//锚点颜色
    ...
    public LineChartView_LEFT(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LineChartView_LEFT(Context context, AttributeSet attrs, int defStyleAttr) {
