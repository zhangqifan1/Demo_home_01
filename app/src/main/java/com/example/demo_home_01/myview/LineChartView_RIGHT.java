...
public class LineChartView_RIGHT extends View {


    private int lineColor =Color.parseColor("#FFA500");//曲线颜色
    private int pointColor = Color.parseColor("#FFA07A");//锚点颜色
    ...
    public LineChartView_RIGHT(Context context) {
        this(context, null);
    }

    public LineChartView_RIGHT(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LineChartView_RIGHT(Context context, AttributeSet attrs, int defStyleAttr) {
